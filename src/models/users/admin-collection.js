...
class AdminCollection {
  ...
  async getSellers(page = 0) {
    let offset = page * 10;
    const selectQuery = `select user_name,user_role,company_name,adress,telephone,is_activated,users.u_id from seller inner join users on seller.u_id = users.u_id where users.user_role ='seller' LIMIT 10 OFFSET $1`;
    const safeValues = [offset];
    return await client
      .query(selectQuery, safeValues)
      .then((result) => result.rows);
  ...
  async getActiveSellers(page = 0) {
    let offset = page * 10;
    const selectQuery = `select user_name,user_role,company_name,adress,telephone,is_activated,users.u_id from seller inner join users on seller.u_id = users.u_id where users.user_role ='seller' and users.is_activated = true LIMIT 10 OFFSET $1`;
    const safeValues = [offset];
    return await client
      .query(selectQuery, safeValues)
      .then((result) => result.rows);
  ...
  async getDeactivateSellers(page = 0) {
    let offset = page * 10;
    const selectQuery = `select user_name,user_role,company_name,adress,telephone,is_activated,users.u_id from seller inner join users on seller.u_id = users.u_id where users.user_role ='seller' and users.is_activated = false LIMIT 10 OFFSET $1`;
    const safeValues = [offset];
    return await client
      .query(selectQuery, safeValues)
      .then((result) => result.rows);
  ...
  async getDeletedProducts(page = 0) {
    let offset = page * 10;
    const selectQuery = `select name,description,main_img,price,category.category_name,seller.company_name,is_deleted,products.id from products inner join seller on products.seller_id = seller.id inner join category on products.category_id = category.id where is_deleted = true LIMIT 10 OFFSET $1`;
    const safeValues = [offset];
    return await client
      .query(selectQuery, safeValues)
      .then((result) => result.rows);
  ...
  async getInCartProducts(page = 0) {
    let offset = page * 10;
    const selectQuery = `select name,description,main_img,price,category.category_name,seller.company_name,is_bought,products.id from products inner join seller on products.seller_id = seller.id inner join category on products.category_id = category.id inner join buyer_cart on products.id = buyer_cart.p_id where is_bought = false LIMIT 10 OFFSET $1`;
    const safeValues = [offset];
    return await client
      .query(selectQuery, safeValues)
      .then((result) => result.rows);
  ...
  async getActiveProducts(page = 0) {
    let offset = page * 10;
    const selectQuery = `select name,description,main_img,price,category.category_name,seller.company_name,is_deleted,products.id from products inner join seller on products.seller_id = seller.id inner join category on products.category_id = category.id where is_deleted = false LIMIT 10 OFFSET $1`;
    const safeValues = [offset];
    return await client
      .query(selectQuery, safeValues)
      .then((result) => result.rows);
  ...
  async getAllProducts(page = 0) {
    let offset = page * 10;
    const selectQuery = `select name,description,main_img,price,category.category_name,seller.company_name,is_deleted,products.id from products inner join seller on products.seller_id = seller.id inner join category on products.category_id = category.id LIMIT 10 OFFSET $1`;
    const safeValues = [offset];
    return await client
      .query(selectQuery, safeValues)
      .then((result) => result.rows);
